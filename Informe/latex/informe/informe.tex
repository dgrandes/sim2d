...
\begin{figure}
\centering
\includegraphics[width = 8cm]{images/sensores.png}
...
Se decidió por un es esquema de refuerzos negativos. Cada vez que el agente choca con otro agente se refuerza con un valor de $-1$. La decisióon se basa en qe al seguir presente la fuerza de deseo mientras el agente aprende utilizando Q-Learning no es necesario recompensarlo por avanzar correctamente.
...
\begin{figure}
\centering
\includegraphics[width = 10cm]{images/exploracionvsexplotacion.png}
