...
En el escenario 2 (figura \ref{figExpRes2}) se nota claramente el punto de inflexión entre exploración y explotación.

Observando la matriz Q se puede ver que los valores de utilidad son los esperados en casi todos los casos.

Cabe destacar que viendo los gráficos de utilidad se nota claramente que alrededor del paso 5000 en el escenario 1 la performance experimenta una mejoría notable causada por la menor posibilidad movimientos random y el aprovechamiento de la estrategia aprendida (figura \ref{figExpRes1}).
\section{Conclusión}
